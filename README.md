...
- This Web Application is single page application developed with React that generates random greetings from an API.
...
```sh
  git clone https://github.com/Aseadd_/hello-rails-frontend.git
```
